      ...
      <div className="max-w-full mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-0 mb-4 sm:mb-8">
          ...
          <div className="relative w-full sm:w-auto">
            <select className="w-full sm:w-auto bg-gradient-to-br bg-gradient-to-br from-gray-900 via-gray-800 to-indigo-900 text-white px-3 sm:px-4 py-2 pr-10 rounded-lg border border-slate-700 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm">
        ...
        {/* Table */}
        <div className=" rounded-xl border bg-gradient-to-br bg-gradient-to-br from-gray-900 via-gray-800 to-indigo-900 overflow-hidden">
          {/* Table Header */}
          <div className="grid grid-cols-5 gap-2 sm:gap-4 px-3 sm:px-6 py-3 sm:py-4 bg-gradient-to-br bg-gradient-to-br from-gray-900 via-gray-800 to-indigo-900 border-b border-slate-700">
