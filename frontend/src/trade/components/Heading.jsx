  ...
  return (
    <div className="px-3 sm:px-4 md:px-6 lg:px-[100px] py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-0">
      ...
      <div className="flex items-center gap-2 sm:space-x-3 w-full sm:w-auto">
        ...
        <button className="bg-slate-700 hover:bg-slate-600 text-white px-3 sm:px-4 py-2 rounded-lg flex items-center space-x-2 transition-colors text-sm font-medium flex-1 sm:flex-none">
        ...
        <div className="hidden sm:flex items-center space-x-3">
          ...
          <button className="bg-slate-700 hover:bg-slate-600 text-white px-4 py-2 rounded-lg flex items-center space-x-2 transition-colors text-sm font-medium">
